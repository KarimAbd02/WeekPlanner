...
namespace CalendarPlannerExample
{
    public partial class Form8 : Form
    {
        ...
        public Form8()
        {
            ...
            weekPlanner1.Columns.Add("Время", "Время", 250);
        ...
        private void btn_AddRow_Click(object sender, EventArgs e)
        {
            ...
            ColumnRows["Время"].Data.Add(Guid.NewGuid().ToString().Substring(0, 8));
            ColumnRows["Время"].Data.Add(Guid.NewGuid().ToString().Substring(0, 8));
        ...
        private void btn_AddColumnData_Click(object sender, EventArgs e)
        {
            ...
            {
                var row = weekPlanner1.Rows.ElementAt(weekPlanner1.SelectedRowIndex);
                row.Columns["Время"].Data.Add(Guid.NewGuid().ToString().Substring(0, 8), Color.Red);
            }
        }
        ...
        private void weekPlanner1_Load(object sender, EventArgs e)
        {
